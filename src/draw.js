import { HERO_SPEED, RENDER_X, scaling, updateScaling } from "./config.js";
...
export function drawHero(cxt, hero) {
  ...
  var rotation = Math.max(
    maxUpwardTilt,
    Math.min(maxDownwardTilt, (hero.vel.y / maxVelocity) * maxDownwardTilt),
  );
  ...
  var bodyGradient = cxt.createRadialGradient(
    centerX - radius * 0.4,
    centerY - radius * 0.4,
    0,
    centerX,
  ...
  var bellyGradient = cxt.createRadialGradient(
    centerX,
    centerY + radius * 0.3,
    0,
    centerX,
  ...
  var blushGradient = cxt.createRadialGradient(
    centerX - radius * 0.4,
    centerY + radius * 0.2,
    0,
    centerX - radius * 0.4,
  ...
  var beakGradient = cxt.createLinearGradient(
    centerX + radius * 0.6,
    centerY - radius * 0.15,
    centerX + radius * 1.1,
    centerY + radius * 0.15,
  ...
  var eyeGradient = cxt.createRadialGradient(
    centerX + radius * 0.2,
    centerY - radius * 0.25,
    0,
    centerX + radius * 0.2,
  ...
  var pupilGradient = cxt.createRadialGradient(
    centerX + radius * 0.25,
    centerY - radius * 0.2,
    0,
    centerX + radius * 0.25,
  ...
  var rightEyeGradient = cxt.createRadialGradient(
    centerX + radius * 0.5,
    centerY - radius * 0.35,
    0,
    centerX + radius * 0.5,
  ...
  var wingGradient = cxt.createLinearGradient(
    centerX - radius * 1.2,
    centerY,
    centerX + radius * 0.2,
    centerY + radius * 0.8,
  ...
  var tailGradient = cxt.createRadialGradient(
    centerX - radius * 0.8,
    centerY + radius * 0.2,
    0,
    centerX - radius * 0.8,
...
export function drawCloud(cxt, cloud) {
  ...
  cloudCtx.beginPath();
  cloudCtx.arc(
    offsetX + size * 0.2 * stretch,
    offsetY - size * 0.3 * puffiness,
    size * 0.35 * puffiness,
    0,
    2 * Math.PI,
  );
...
export function drawBuilding(cxt, building) {
  ...
  if (building.windows && w > 20 * scaling.SCALE_X) {
    ...
    var windowColor =
      building.color === "#3F4147"
        ? "#4F5157"
        : building.color === "#4B4D52"
          ? "#5B5D62"
          : building.color === "#5A4741"
            ? "#6A5751"
            : building.color === "#6B5D56"
              ? "#7B6D66"
              : building.color === "#525459"
                ? "#626469"
                : building.color === "#4A5451"
                  ? "#5A6461"
                  : building.color === "#3A4C4C"
                    ? "#4A5C5C"
...
function updateOverlaySizes(canvasWidth, canvasHeight) {
  ...
  document.getElementById("titleHighScoreValue").style.fontSize =
    24 * scaleFactor + "px";
  document.getElementById("titleHighScoreInitials").style.fontSize =
    14 * scaleFactor + "px";
  ...
  startButton.style.padding =
    15 * scaleFactor + "px " + 30 * scaleFactor + "px";
  instructionsButton.style.fontSize = 24 * scaleFactor + "px";
  instructionsButton.style.padding =
    15 * scaleFactor + "px " + 30 * scaleFactor + "px";
  ...
  initialsInput.style.padding =
    10 * scaleFactor + "px " + 15 * scaleFactor + "px";
